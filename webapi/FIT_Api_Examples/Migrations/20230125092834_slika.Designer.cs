...
namespace FIT_Api_Examples.Migrations
{
    ...
    [Migration("20230125092834_slika")]
    partial class slika
    {
            ...
            modelBuilder.Entity("FIT_Api_Examples.Modul3_MaticnaKnjiga.Models.UpisAkGodine", b =>
                {
                    ...
                    b.Property<int>("akGodina_id")
                        .HasColumnType("int");

                    b.Property<float>("cijena_skolarine")
                        .HasColumnType("real");

                    b.Property<DateTime?>("datum_ovjere_zimski")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("datum_upisa_zimski")
                        .HasColumnType("datetime2");

                    b.Property<int>("evidentiraoKorisnik_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("akGodina_id");

                    b.HasIndex("evidentiraoKorisnik_id");
            ...
            modelBuilder.Entity("FIT_Api_Examples.Modul3_MaticnaKnjiga.Models.UpisAkGodine", b =>
                {
                    b.HasOne("FIT_Api_Examples.Modul2.Models.AkademskaGodina", "akGodina")
                        .WithMany()
                        .HasForeignKey("akGodina_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FIT_Api_Examples.Modul0_Autentifikacija.Models.KorisnickiNalog", "evidentiraoKorisnik")
                        .WithMany()
                        .HasForeignKey("evidentiraoKorisnik_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
